...
ecls = ecls %>% mutate(asian    = if_else(race == "Asian",    1, 0))
ecls = ecls %>% mutate(black    = if_else(race == "Black",    1, 0))
ecls = ecls %>% mutate(hispanic = if_else(race == "Hispanic", 1, 0))
ecls = ecls %>% mutate(other    = if_else(race == "Other",    1, 0))
ecls = ecls %>% mutate(white    = if_else(race == "White",    1, 0))
