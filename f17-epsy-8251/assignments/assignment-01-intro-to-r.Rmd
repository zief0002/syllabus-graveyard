...
Use the `data.frame()` function to enter these data into a data frame called `reading`. There should be two columns in the data frame. The first column you should name `month` and the second should be named `pages`.
...
Use RStudio to open the \textit{goodreads-2016.csv} dataset and assign it into an object called `read`. This file contains data from Andy's [GoodReads](http://www.goodreads.com) entries. The data consists of 12 variables and 291 observations. The variables are:
